  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 28 }}>
        <div style={{ fontFamily: 'var(--font-mono)', fontSize: 11, color: 'var(--gray-3)', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 6 }}>Espace Admin</div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '260px 1fr', gap: 24, alignItems: 'start' }}>
        ...
        <div style={{ background: 'white', borderRadius: 'var(--radius-lg)', border: '1px solid var(--gray-1)', boxShadow: 'var(--shadow-sm)', overflow: 'hidden' }}>
          ...
          <div style={{ padding: 28, textAlign: 'center', borderBottom: '1px solid var(--gray-1)' }}>
            ...
            <span style={{ display: 'inline-block', marginTop: 10, fontSize: 11, fontWeight: 600, padding: '3px 10px', borderRadius: 20, background: '#FEF3C7', color: '#92400E' }}>
              Administrateur
            </span>
          </div>
          ...
          {tab === 'notifs' && (
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                {[
                  { label: 'Alertes système',              sub: 'Recevoir les alertes critiques du système', defaultVal: true },
                  { label: 'Nouveaux rendez-vous',        sub: 'Notification pour chaque nouveau RDV', defaultVal: true },
                  { label: 'Annulations & modifications',  sub: 'Alertes sur les changements de RDV',       defaultVal: true },
                  { label: 'Rapports hebdomadaires',       sub: 'Résumés statistiques chaque semaine',       defaultVal: false },
                ].map(pref => (
